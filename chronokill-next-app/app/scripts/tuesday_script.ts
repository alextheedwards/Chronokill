...
import imgRebecca from '../../public/actors/rebecca.png'
  ...
  export const tuesday_script: SceneScript = [
    ...
    ["check", () => tuesday_script_answers.decision1 === decision1[0]], //immediatley disconnect device
    ["rchar", ActorSimon],
    ...
    ["check", () => tuesday_script_answers.decision1 === decision1[1]], //access threat
    ...
    ["check", () => tuesday_script_answers.decision1 === decision1[2]], //implement strict link filter
    ["rchar", ActorSimon],
    ...
    ["check", () => tuesday_script_answers.decision2 === decision2[0]], //manually verify access
    ...
    ["check", () => tuesday_script_answers.decision2 === decision2[1]], //guest passes
